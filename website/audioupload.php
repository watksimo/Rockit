...
{
echo "Please upload an <b>audio</b> file in a <b>.mp3</b> or <b>.wmv</b> format. Click below to close this window and try again.<br>";
$uploadOk =0;
}
...
echo "Your file '" .basename($_FILES[ 'user_audio']['name'])."' has been uploaded. Click below to close this window.";
}
else
{
